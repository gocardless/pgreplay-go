...
func NewDatabase(ctx context.Context, cfg *pgx.ConnConfig) (*Database, error) {
	conn, err := pgx.ConnectConfig(ctx, cfg)
	if err != nil {
		return nil, err
	}

	return &Database{cfg, map[SessionID]*Conn{}}, conn.Close(ctx)
}
...
func (c *Conn) IsAlive(ctx context.Context) bool {
